...
//
// Gesture logic:
//   TAP    < 200ms          → BTN:1   (cycle screen / surprised eyes)
//   DTAP   2 taps < 350ms   → DTAP:1  (happy eyes)
//   LBTN   600–1500ms       → LBTN:1  (switch to eye / angry eyes)
//   SLBTN  > 1500ms release → SLBTN:1 (switch back to sensor / happy rub)
// ============================================================
...
void playDoubleTap() {
    tone(BUZZERPIN, 700, 80);  delay(110);
    tone(BUZZERPIN, 900, 80);  delay(110);
    tone(BUZZERPIN, 1100, 130);
}

void playAngry() {
    tone(BUZZERPIN, 120, 350);
}

void playHappy() {
    tone(BUZZERPIN, 523, 100); delay(120);
    tone(BUZZERPIN, 659, 100); delay(120);
    tone(BUZZERPIN, 784, 200);
}

void playBoot() {
    tone(BUZZERPIN, 262, 100); delay(130);
    tone(BUZZERPIN, 330, 100); delay(130);
    tone(BUZZERPIN, 392, 100); delay(130);
    tone(BUZZERPIN, 523, 150); delay(170);
